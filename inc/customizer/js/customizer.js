(function( $ , api){
    ...
    api.section( 'daren_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'daren_about_section' , function( section ){
    ...
    api.section( 'daren_blog_section' , function( section ){
    ...
    api.section( 'daren_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-daren_contact_custom_formshortcode'),
                selector = $('#_customize-input-daren_contact_formshortcode');
    ...
    // General section
    api.section( 'daren_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#daren_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-daren_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-daren_preloader_color' );
            ...
            var $backtotop          = $( '#daren_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-daren_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-daren_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'daren_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#daren_footer_widget_toggle');
