...
----------------------------------------*/
class daren_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('daren_instagram_photo',esc_html__('[ Daren ] Intagram Photo','daren'),array(
			'description' => esc_html__('Daren Instagram Photo Widget','daren'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'daren');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'daren'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'daren'); ?></label>
...
if(!function_exists('daren_instagram_widgets')):
	function daren_instagram_widgets(){
		register_widget('daren_instagram_photo');
	}
	add_action('widgets_init','daren_instagram_widgets');
endif;
