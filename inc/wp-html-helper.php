...
// image default alt
if( !function_exists( 'daren_img_default_alt' ) ){
	function daren_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'daren_img_tag' ) ){
	function daren_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'daren_anchor_tag' ) ){
	function daren_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'daren_heading_tag' ) ){
	function daren_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'daren_paragraph_tag' ) ){
	function daren_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'daren_other_tag' ) ){
	function daren_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'daren_button_element ' ) ){
	function daren_button_element( array $args ){
