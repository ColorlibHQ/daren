 ...
 */
	...
	class daren_Enqueue{
		...
		public function daren_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'daren_frontend_enqueue_scripts', ) );
		}

		public function daren_frontend_enqueue_scripts( ){
