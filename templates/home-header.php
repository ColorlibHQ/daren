    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = daren_opt( 'daren_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo daren_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( daren_featured_post_cat() ){
                                echo '<span class="entry__category">'.daren_featured_post_cat().'</span>';
                            }
                            ?>
